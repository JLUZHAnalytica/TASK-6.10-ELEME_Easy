...
# "name":"盖浇饭""name":"粤菜"
lei_all = load_dict['rst']['flavors']
lei = []
for k in lei_all:
    lei.append(k['name'])
# "business_info":"{"recent_order_num_display":"月售400"}",
xiaoliang = load_dict['rst']['business_info'].split(
    ":")[-1].replace('}', '')  # 订单量
# "rating":4.8
fen = load_dict['rst']['rating']  # 店铺评分
# rating_count":330
fencount = load_dict['rst']['rating_count']  # 评分数

# "address":"广州市荔湾区小梅大街2号二层123房"
address = load_dict['rst']['address']
city = address[0:3]

# latitude":23.131682,"longitude":113.245003
latitude = load_dict['rst']['latitude']  # 经度
longitude = load_dict['rst']['longitude']  # 纬度
ll = []
ll.append(latitude)
ll.append(longitude)
...
#            "09:30/23:30"
#        ]
openhour = load_dict['rst']['opening_hours']  # 营业时间

# "phone":null
phone = load_dict['rst']['phone']  # 电话

# closing_count_down
yinye = load_dict['rst']['closing_count_down']
if yinye:
    yyzt = '营业'
else:
    yyzt = '关闭'
